...
## Target Audience
- Government Traffic Authorities: To monitor road safety statistics and implement data-driven policies.
- Urban Planners and Civil Engineers: For infrastructure planning and identifying high-risk zones.
- Researchers and Analysts: To study accident trends and correlate them with road/environmental factors.
- Public Safety Organizations and NGOs: For awareness campaigns and accident prevention strategies.
- General Public: To understand accident-prone zones and make safer travel decisions.
<br><br>
...
- Since urban areas contribute to 61% of casualties, focused interventions such as:
 ...
 ### 1. Scope:
- Visual analysis of total, fatal, serious, and slight casualties.
- Categorization by vehicle types, road surface types, road types, and light conditions.
- Year-wise comparison (2021 vs. 2022) and monthly casualty trends.
...
- Relies on accuracy and completeness of the original dataset; missing or misreported data may skew insights.
- Static in Excel format; limited real-time data integration or mobile responsiveness.
<br><br>
